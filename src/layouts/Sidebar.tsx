  ...
  const homeItems: MenuItem[] = [
    ...
    { 
      ...
      subItems: [
        ...
        { id: 'additional-options', title: 'Additional Options', route: '/dropdown-settings/additional-options' },
        { id: 'freebies', title: 'Freebies', route: '/dropdown-settings/freebies' },
        { id: 'placement-measurements', title: 'Placement Measurements', route: '/dropdown-settings/placement-measurements' },
